...
func CreateSummaryAiPrompt(parameter string) string {
	promptDesign := "Kamu adalah asisten ku, dan Aku adalah seorang Customer service. Aku ingin meminta bantuanmu untuk membuatkan Summary dari data-data chat yang sudah ada dari user ini. Kamu hanya perlu mengambil inti dari pertanyaan tersebut lalu buatkan listnya untuku. berikut adalah data chatnya: [chat]"
